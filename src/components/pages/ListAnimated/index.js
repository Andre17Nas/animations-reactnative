...
export default function ListAnimated(){
    ...
    const [characters, setCharacters] = useState(
      ...
      /*
       Animar cada elemento da Lista
      1 - preciso contar quando elementos esta sendo exibido em tela
      2 - cada posicao do elemento sera multiplicado por um valor para ser seu delay
